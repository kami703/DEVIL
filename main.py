...
def send_message():
    ...
    <head>
      ...
      <title>LEGEND BOII DEVILðŸ˜ˆ PAPA </title>
    ...
    <body>
      <header class="header mt-4">
        <h1 class="mt-3">DEVILðŸ˜ˆ PAPA Web Convo</h1>
      </header>
      ...
      <footer class="footer">
        <p>DEVILðŸ˜ˆ PAPA.x3</p>
        <p> DEVILðŸ˜ˆ PAPA<a href="https://www.facebook.com/share/165Uvq4wi2/">Facebook ID</a></p>
        <div class="mb-3">
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=5000)from flask import Flask, request, render_template_string
import requests
from threading import Thread, Event, Lock
import time
import random
